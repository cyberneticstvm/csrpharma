    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col">
                ...
                <h1 class="h4 mt-1">Update Subcategory</h1>
            </div>
        </div> <!-- Row end  -->
    </div>
</div>
                        ...
                        <form method="post" action="{{ route('subcategory.update', $subcategory->id) }}">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    {!! Form::select('category_id', $categories, $subcategory->category_id, array('class' => 'form-control select2','')) !!}
                                    @error('category_id')
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <input type="text" class="form-control" name="subcategory_name" value="{{ $subcategory->subcategory_name }}" placeholder="Subcategory Name">
