    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col">
                ...
                <h1 class="h4 mt-1">Add new Manufacturer</h1>
            </div>
        </div> <!-- Row end  -->
    </div>
</div>
    ...
    <div class="container">        
        <div class="row g-4">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-body">                        
                        <form method="post" action="{{ route('manufacturer.save') }}">
                            @csrf
                            <div class="row g-4">
                                <h6 class="text-primary">Basic Information</h6>
                                <div class="col-sm-5">
                                    <label class="form-label">Manufacturer Name <span class="req">*</span></label>
                                    <input type="text" class="form-control" name="manufacturer_name" value="{{ old('manufacturer_name') }}" placeholder="Manufacturer Name">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" class="form-control" name="manufacturer_code" value="{{ old('manufacturer_code') }}" placeholder="Manufacturer Code">
