                        ...
                        <form method="post" action="{{ route('product.update', $product->id) }}">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input type="number" class="form-control" name="cgst" step="1" min="0" max="100" value="{{ $product->cgst }}" placeholder="0%">
                                    @error('cgst')
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input type="number" class="form-control" name="sgst" step="1" min="0" max="100" value="{{ $product->sgst }}" placeholder="0%">
                                    @error('sgst')
