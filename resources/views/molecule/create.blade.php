    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col">
                ...
                <h1 class="h4 mt-1">Add new Molecule</h1>
            </div>
        </div> <!-- Row end  -->
    </div>
</div>
    ...
    <div class="container">        
        <div class="row g-4">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-body">                        
                        <form method="post" action="{{ route('molecule.save') }}">
                            @csrf
                            <div class="row g-4">
                                <h6 class="text-primary">Basic Information</h6>
                                <div class="col-sm-5">
                                    <label class="form-label">Molecule Name <span class="req">*</span></label>
                                    <input type="text" class="form-control" name="molecule_name" value="{{ old('molecule_name') }}" placeholder="Molecule Name">
                                    @error('molecule_name')
